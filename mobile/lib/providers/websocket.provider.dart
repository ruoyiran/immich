...
class WebsocketNotifier extends StateNotifier<WebsocketState> {
  ...
  void _processBatchedAssetUploadReadyV1() {
    ...
    try {
      unawaited(_ref.read(backgroundSyncProvider).syncWebsocketBatchV1(_batchedAssetUploadReady.toList()));
    } catch (error) {
  ...
  void _processBatchedAssetUploadReadyV2() {
    ...
    try {
      unawaited(_ref.read(backgroundSyncProvider).syncWebsocketBatchV2(_batchedAssetUploadReady.toList()));
    } catch (error) {
