...
final class Schema32 extends i0.VersionedSchema {
  ...
  final i1.Index idxLocalAssetContentMd5Size = i1.Index(
    'idx_local_asset_content_md5_size',
...
class Shape52 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get checksum =>
      columnsByName['checksum']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get contentMd5 =>
      columnsByName['content_md5']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get contentSize =>
      columnsByName['content_size']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get hashAlgorithm =>
      columnsByName['hash_algorithm']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get hashedModifiedAt =>
      columnsByName['hashed_modified_at']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get isFavorite =>
      columnsByName['is_favorite']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get orientation =>
      columnsByName['orientation']! as i1.GeneratedColumn<int>;
...
final class Schema33 extends i0.VersionedSchema {
  ...
  late final Shape53 remoteExifEntity = Shape53(
    source: i0.VersionedTable(
      entityName: 'remote_exif_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  final i1.Index idxRemoteExifPlacePath = i1.Index(
    'idx_remote_exif_place_path',
    'CREATE INDEX IF NOT EXISTS idx_remote_exif_place_path ON remote_exif_entity (country, state, city, district)',
  );
  final i1.Index idxRemoteAlbumAssetAlbumAsset = i1.Index(
    'idx_remote_album_asset_album_asset',
    'CREATE INDEX IF NOT EXISTS idx_remote_album_asset_album_asset ON remote_album_asset_entity (album_id, asset_id)',
...
class Shape53 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get country =>
      columnsByName['country']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get district =>
      columnsByName['district']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get dateTimeOriginal =>
      columnsByName['date_time_original']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get description =>
      columnsByName['description']! as i1.GeneratedColumn<String>;
...
final class Schema34 extends i0.VersionedSchema {
  ...
  final i1.Index idxRemoteAssetOwnerVisibilityDeletedLocalDateTime = i1.Index(
    ...
    'CREATE INDEX IF NOT EXISTS idx_remote_asset_owner_visibility_deleted_local_date_time ON remote_asset_entity (owner_id, visibility, deleted_at, local_date_time DESC, id DESC)',
  );
  final i1.Index idxRemoteAssetUploaded = i1.Index(
    'idx_remote_asset_uploaded',
    'CREATE INDEX IF NOT EXISTS idx_remote_asset_uploaded ON remote_asset_entity (uploaded_at)',
...
final class Schema35 extends i0.VersionedSchema {
  ...
  late final Shape54 remoteExifEntity = Shape54(
    source: i0.VersionedTable(
      entityName: 'remote_exif_entity',
      withoutRowId: true,
      isStrict: true,
...
class Shape54 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get district =>
      columnsByName['district']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get placeDisplayName =>
      columnsByName['place_display_name']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get dateTimeOriginal =>
      columnsByName['date_time_original']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get description =>
      columnsByName['description']! as i1.GeneratedColumn<String>;
